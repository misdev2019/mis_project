...
'body,html{margin:0px;height:100%;background:white;}a,li,input {font-family:"Verdana","Arial";font-size:12px;}'+
'a {height:18px;color:#000;padding-top:2px;text-decoration:none;display:block;}'+
'a:hover{height:17px;padding-top:1px;border:1px solid #000;background:white;}'+
'.CurrentDate {height:17px;padding-top:1px;border:1px solid #000;background: white;}'+
...
'#Tools {width:204px;background:LightGrey;padding:0px;}'+
'#Tools li{padding-bottom:1px;}'+
'#Tools a{color:black;}'+
'#Tools a:hover{border:1px solid ;background:Grey;}'+
'#Title {width:204px;background:Grey;border-bottom:1px solid #000;}'+
...
'#SArr {width:19px;height:18px;background:white;font-size:10px;text-align:center;color:LrightGrey;border:1px solid #88A9C9;border-left:0;margin-right:3px;cursor:pointer;}'+
'#Select {width:63px;border:1px solid #8AC;background:white;height:146px;}'+
'#Select a{height:16px;padding-left:3px;}'+
'#Select a:hover{color:#000;background:LightGrey;padding-top:2px;border:0;}'+
'#Select #SelectBn {background:white;font-size:8px;line-height:7px;height:7px;text-align:center;color:black;}'+
'#Select #SelectBn:hover{background:Grey;color:white;}#SArr,#sYear,#sMonth{float:left;}'+
...
content+=((i+start)%7<2)?' style="color:black;"':'';
content+='>'+PrNum+'</a></li>';
PrNum++;
}
content+='</ul></div>';
